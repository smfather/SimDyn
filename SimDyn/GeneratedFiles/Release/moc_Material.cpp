...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DialogMaterial_t, stringdata) + ofs \
...
const QMetaObject DialogMaterial::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_DialogMaterial.data,
      qt_meta_data_DialogMaterial,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DialogMaterial::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DialogMaterial.stringdata))
