...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ApplicationWindow_t, stringdata) + ofs \
...
const QMetaObject ApplicationWindow::staticMetaObject = {
    { &SimDyn::staticMetaObject, qt_meta_stringdata_ApplicationWindow.data,
